...
class doc2vec:
    ...
    def __init__(self, df, X, Y, build=False, vector_size=300, window_size=15, min_count=2, negative_size=5,
                 train_epoch=50, iterations=10):
            ...
            for i in (range(iterations)):
                ...
                for index, datapoint in train.iterrows():
                    ...
                    labeled_sentences.append(
                        TaggedDocument(words=tokenized_words, tags=[datapoint[i] for i in df_tags]))
